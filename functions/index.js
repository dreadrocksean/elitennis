...
export const createCheckoutSession = onRequest(
  ...
  async (req, res) => {
    ...
    try {
      ...
      const baseUrl = ALLOWED_ORIGINS.includes(origin) || /\.vercel\.app$/.test(origin || '')
        ? origin
        : 'https://elitenniskc.com'
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        metadata: { bookingId, date, time, name: name || '', phone: phone || '', notes: notes || '' },
