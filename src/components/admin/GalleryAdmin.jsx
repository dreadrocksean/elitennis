    ...
    >
      <div className="space-y-3">
        {items.map((it, i) => (
          <div
            key={it.id}
            className="flex flex-col gap-3 rounded-2xl border border-forest/10 p-3 sm:flex-row sm:items-center"
          >
            ...
            <button
              ...
              className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-forest/15 text-forest-700 hover:bg-red-50 hover:text-red-600"
            >
              <Trash2 size={16} />
            </button>
          </div>
