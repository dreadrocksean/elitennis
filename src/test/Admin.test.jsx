...
vi.mock('../components/admin/BookingsAdmin.jsx', () => ({ default: () => <div>bookings-panel</div> }))
vi.mock('../components/admin/ContentAdmin.jsx', () => ({ default: () => <div>content-panel</div> }))
vi.mock('../components/admin/GalleryAdmin.jsx', () => ({ default: () => <div>gallery-panel</div> }))
vi.mock('../components/admin/TestimonialsAdmin.jsx', () => ({ default: () => <div>testimonials-panel</div> }))
vi.mock('../components/admin/AvailabilityAdmin.jsx', () => ({ default: () => <div>availability-panel</div> }))
